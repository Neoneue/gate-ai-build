...
| Missing design context for Impeccable-style work | `.claude/front-end-developer/skills/impeccable/SKILL.md` (teach / craft) |
...
2. **While building** — `.claude/front-end-developer/skills/web-design-guidelines/SKILL.md` + `.claude/front-end-developer/knowledge/core/craft-methodology.md` + `.claude/front-end-developer/skills/impeccable/SKILL.md` (and `.claude/front-end-developer/skills/impeccable/reference/` as needed) for anti-slop and hierarchy. **`.claude/front-end-developer/skills/svg-animations/SKILL.md` whenever the page uses custom SVG** (diagrams, hero art, logos, path motion)—do not rely on generic divs + Tailwind alone for the “designed” moments.
...
3. **Apply .claude/front-end-developer/knowledge/core + web-design-guidelines + .claude/front-end-developer/knowledge/shadcn** — product-appropriate layout, UX habits, anti-default patterns (and `.claude/front-end-developer/skills/impeccable/reference/` when needed)
