...
metadata:
  upstream_source: https://github.com/supermemoryai/skills/tree/main/svg-animations
  package_note: Vendored into front-end-developer; re-copy from upstream periodically to pick up fixes.
---
