...
- [x] **wdg-1 HIGH** (applied 2026-09-20, `a2debd7`; also converted the third `NavTableRow` in Dashboard.tsx:876 (security preview) `tr-role` and added `aria-label` to the primitive's Omit so no call site can name the `<tr>`) components/ui/table.tsx:184, components/ui/table.tsx:185
...
- [x] **wdg-4 HIGH** (applied 2026-09-20, `a2debd7`; `<main>` also took `tabIndex={-1}` so focus lands after activation, and `focus:outline-none` since the pane is not operable; skip link uses the design.md ring recipe + `type-label-14`) `skip-link` layouts/DashboardChrome.tsx:265
...
- [x] **wdg-5 MEDIUM** (applied 2026-09-20, `f54859b`; nav rows, logomark, brand and Account settings are `<Link>`; Theme / Docs / Sign out stay buttons; `onNavItemClick` added so the mobile Sheet still closes) `link-not-button` components/ui/sidebar.tsx:187, components/ui/sidebar.tsx:312, components/ui/sidebar.tsx:439, components/ui/sidebar.tsx:457, components/ui/sidebar.tsx:468, components/ui/sidebar.tsx:476, layouts/DashboardChrome.tsx:402
...
- [x] **wdg-6 MEDIUM** (applied 2026-09-20, `f54859b`; `BackLink href`, `TextLink to` (a plain `as="a"` full-reloads, now external-only) `link-not-button`; Button sites use `render={<Link />}`) components/ui/text-link.tsx:64, components/ui/back-link.tsx:37
...
- [x] **wdg-8 MEDIUM** (applied 2026-09-20, `f54859b`) `landmarks` layouts/DashboardChrome.tsx:359, layouts/AuthLayout.tsx:258
...
- [x] **wdg-11 MEDIUM** (applied 2026-09-20, `f54859b`; `@fontsource-variable/geist-mono` added, families renamed to `Geist Variable` / `Geist Mono Variable`; preload skipped, Vite hashes the asset) `self-host-fonts` src/index.css:2, src/index.css:6
...
- [x] **wdg-12 MEDIUM** (applied 2026-09-20, `f54859b`) `touch-manipulation` components/ui/button.tsx:14
...
- [ ] **wdg-7 LOW** `heading-order` components/ui/card.tsx:123
...
- [ ] **wdg-9 LOW** `label-for` pages/requests/RequestsTable.tsx:326, pages/requests/RequestsTable.tsx:349, pages/requests/RequestsTable.tsx:371, pages/requests/RequestsTable.tsx:394, pages/security/EventsTable.tsx:386, pages/security/EventsTable.tsx:408, pages/security/EventsTable.tsx:429, pages/security/EventsTable.tsx:451, pages/AuditTrail.tsx:472, pages/AuditTrail.tsx:486, pages/AuditTrail.tsx:503, pages/teams/dialogs.tsx:417, pages/teams/dialogs.tsx:728
...
- [ ] **wdg-10 LOW** `theme-color` index.html:6
...
- [x] **wdg-2 LOW** (applied 2026-09-20, `cc5b345`) `focus-visible` components/ui/message-block.tsx:185, components/ui/message-block.tsx:214
...
- [x] **wdg-3 LOW** (applied 2026-09-20, `cc5b345`) `focus-visible` components/ui/code-card.tsx:167, components/ui/code-card.tsx:177
  - Severity: was HIGH, downgraded 2026-09-20. No `outline-none` on these buttons and the base layer applies `outline-ring/50`, so the browser default focus-visible outline shows. Ring-recipe consistency, not WCAG 2.4.7.
...
- [ ] **wdg-15 LOW** (skipped by decision 2026-09-20: keep the blur for now, the blur-family row stays OPEN in the settled table) `no-filter-transition` components/ui/theme-toggle.tsx:32, components/ui/theme-toggle.tsx:42, layouts/DashboardChrome.tsx:378, layouts/DashboardChrome.tsx:388
...
- [x] **wdg-17 LOW** (applied 2026-09-20, `cc5b345`) `motion-reduce` components/ui/sonner.tsx:21, pages/onboarding-shared.tsx:210
...
- [x] **wdg-18 LOW** (applied 2026-09-20: Conversations line `f54859b`, feedback-fab + RequestsTable `cc5b345`; zero live `hover-fine:` left in `src`) `dead-hover-fine` components/ui/feedback-fab.tsx:101, pages/Conversations.tsx:670, pages/requests/RequestsTable.tsx:719
...
- [ ] **wdg-19 LOW** `safe-area` components/ui/feedback-fab.tsx:81, index.html:6
...
- [x] **wdg-20 LOW** (applied 2026-09-20, `cc5b345`) `curly-quotes` components/ui/workspace-switcher.tsx:55, components/ui/workspace-switcher.tsx:75, components/ui/workspace-switcher.tsx:84, components/ui/workspace-switcher.tsx:96, components/ui/workspace-switcher.tsx:108
...
- [x] **wdg-21 LOW** (applied 2026-09-20, `cc5b345`) `tap-highlight` src/index.css:9
...
- [x] **wdg-22 LOW** (applied 2026-09-20, `cc5b345`) `filter-autocomplete` components/ui/multi-select.tsx:269
...
- [ ] **wdg-23 LOW** `input-type` components/ui/feedback-fab.tsx:229
...
- [x] **wdg-24 LOW** (applied 2026-09-20, `cc5b345`) `focus-visible` pages/requests/RequestDetailBody.tsx:584, pages/requests/RequestDetailBody.tsx:617
  - Severity: was HIGH, downgraded 2026-09-20. No `outline-none` on these buttons and the base layer applies `outline-ring/50`, so the browser default focus-visible outline shows. Ring-recipe consistency, not WCAG 2.4.7.
...
- [x] **wdg-25 MEDIUM** (applied 2026-09-20, `f54859b`; also removed the dead `hover-fine:` on that row (wdg-18 Conversations line) `link-not-button`) pages/Conversations.tsx:672, pages/Conversations.tsx:675
...
- [x] **wdg-26 LOW** (applied 2026-09-20, `cc5b345`) `intl-formatter` pages/Conversations.tsx:339, pages/Conversations.tsx:422
...
- [ ] **wdg-27 LOW** `input-type` pages/Limits.tsx:798, pages/LimitsFree.tsx:583
...
- [ ] **wdg-28 LOW** `input-type` pages/teams/dialogs.tsx:571, pages/teams/dialogs.tsx:616, pages/Team.tsx:698
...
- [ ] **wdg-29 LOW** `input-type` pages/billing/CreditsCard.tsx:467, pages/billing/CreditsCard.tsx:510, pages/billing/CreditsCard.tsx:555, pages/BillingFree.tsx:595, pages/BillingFree.tsx:638, pages/BillingFree.tsx:683
...
- [ ] **wdg-30 LOW** `input-type` pages/Settings.tsx:221
...
- [x] **wdg-31 MEDIUM** (applied 2026-09-20, `f54859b`; `focus-visible:ring-0` never cancelled the ring (ring-offset-2 leaked) `input-label`, so `ring-offset-0` added on the input and the ring lives on the wrapper) pages/SetupManual.tsx:417
...
- [ ] **wdg-32 LOW** `input-type` pages/SignIn.tsx:55, pages/SignUp.tsx:50
  - Severity: was MEDIUM, downgraded 2026-09-20. `type="email"` already gives the email keyboard; `inputMode="email"` adds nothing.
...
Verdict (run 1): Adverse at first run, Qualified after apply. 4 HIGH items (invalid `<tr>` role on a shared primitive, two missing focus rings in shared primitives, one on a detail page, and no skip link) block a clean pass. 12 of the 32 items land in `components/ui/**` or `layouts/**` and fix every page at once.
...
- [x] **smk-1 HIGH** (applied 2026-09-20) `native-button` `Button render={<Link/>}` components/ui/button.tsx:163, pages/Notifications.tsx:657, pages/pro-upgrade-card.tsx:20
...
- [x] **smk-3 HIGH** (applied 2026-09-20) `dead-control` search box not wired pages/requests/RequestsTable.tsx:277, pages/requests/RequestsTable.tsx:212
...
- [x] **smk-2 MEDIUM** (applied 2026-09-20) `motion-initial` motion `m.line` without `initial` components/ui/sliders-horizontal.tsx:116-266, components/ui/sparkles.tsx:153-165
...
- [x] **smk-4 MEDIUM** (applied 2026-09-20) `compression-one-decimal` compression fallback rounds to an integer pages/requests/RequestDetailBody.tsx:1236
...
Verdict (run 3): Adverse at first run, Clean after apply. Four defects: two live console errors (one on nearly every page), one dead search box, one rounding rule breach. All four fixed the same day.

## Patterns

- `index-as-key`: rbp-1, rbp-4, rbp-9, rbp-13. Lint `react/no-array-index-key` (ESLint) or Biome `noArrayIndexKey`.
- `js-index-maps`, linear `.find` per row: rbp-5, rbp-6, rbp-7, rbp-10. No lint; review-time rule, hoist a Map.
- `motion-reduce`: wdg-3, wdg-16, wdg-17. Extend `scripts/check-design-tokens.mjs` (transition without `motion-reduce:`).
- `focus-visible`: wdg-2, wdg-24, wdg-31. Lint candidate: `focus-visible:` absent on any element with `tabIndex` or `onClick`.
- `input-type`, `label-for`: wdg-9, wdg-23, wdg-27, wdg-28, wdg-29, wdg-30, wdg-32. Skipped as mobile-only; a jsx-a11y rule exists if ever wanted.
- `link-not-button`, `native-button`: wdg-5, wdg-6, wdg-25, smk-1. Lint candidate: `Button render={<Link` without `nativeButton={false}`.
- `motion-initial`: smk-2. Grep-able: `variants=` without `initial=` in `components/ui/*.tsx`.
- `client-event-listeners`, `js-cache-function-results`: rbp-2, rbp-3. Review-time; one `useMediaQuery` / `REDUCE_MOTION` owner.
- console.error on the demo path (`native-button`, `motion-initial`): smk-1, smk-2. Now gated by the route smoke and Playwright tiers on every commit.
