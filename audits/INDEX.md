...
- `imp` impeccable polish (review mode, Opus, browser), Models + Token Savings all twins: imp-1 to imp-20, 20/20 applied (imp-19, 20 surfaced by the apply passes).
  Clean after apply; at review Qualified. 2 HIGH (Free upsell `~20%` vs 13.7% on the same page; tooltip triggers without tabIndex), 9 MEDIUM, 7 LOW.
