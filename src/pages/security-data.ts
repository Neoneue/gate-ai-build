...
export const EVENT_ROWS: EventRow[] = [
  ...
  {
    time: "2026-06-06 00:50:45",
    relative: "now",
    type: "injection",
    key: "design-agent (sk-gw-ef7)",
    action: "blocked",
  ...
  {
    time: "2026-05-12 09:38:21",
    relative: "12m ago",
    type: "credential",
    key: "prod-web (sk-gw-438)",
    action: "blocked",
    requestId: "req_aurora_4212",
    conversationId: "cnv_aurora_42",
    keyTier: "critical",
    status: "error",
    code: "403",
  ...
  {
    time: "2026-05-12 09:27:14",
    relative: "23m ago",
    type: "credential",
    key: "prod-web (sk-gw-438)",
    action: "blocked",
    requestId: "req_aurora_4223",
    conversationId: "cnv_aurora_42",
    keyTier: "critical",
    status: "error",
    code: "403",
