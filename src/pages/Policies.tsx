            ...
            {options.map((opt, i) => (
              <RadioGroupItem
                ...
                className={cn(
                  ...
                  "relative z-10 bg-muted transition-[color,background-color,border-color,scale] duration-150 ease-out hover:scale-110 hover:border-border-hover motion-reduce:transform-none dark:bg-muted [&_[data-slot=radio-group-indicator]]:hidden",
