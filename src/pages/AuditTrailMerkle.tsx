...
/** Comparable value per sortable column for the audit event log. Mirrors the
 *  canonical /audit-trail accessor. Event ID and Fingerprint are opaque
 *  high-entropy hashes with no meaningful order, so they stay plain. */
