...
const EVENT_ROWS: EventRow[] = [
  ...
  { time: '2026-05-12 09:43:10', relative: '7m ago',  type: 'injection',  key: 'prod-web (sk-gw-438)',   action: 'flagged',  requestId: 'req_lyra_4207',     conversationId: 'cnv_lyra_92',      keyTier: 'elevated', status: 'success', code: '200', inTokens: '412',   outTokens: '188',   latency: '3.20s',  turn: 8,  totalTurns: 14 },
  ...
  { time: '2026-05-12 09:40:44', relative: '9m ago',  type: 'injection',  key: 'prod-agent (sk-gw-930)', action: 'blocked',  requestId: 'req_vela_4209',     conversationId: 'cnv_vela_21',      keyTier: 'critical', status: 'error',   code: '403', inTokens: '3,902', outTokens: '0',     latency: '2.10s',  turn: 7,  totalTurns: 12 },
  ...
  { time: '2026-05-12 09:36:33', relative: '13m ago', type: 'phi',        key: 'prod-web (sk-gw-438)',   action: 'flagged',  requestId: 'req_orion_4213',    conversationId: 'cnv_orion_70',     keyTier: 'elevated', status: 'success', code: '200', inTokens: '1,402', outTokens: '482',   latency: '6.40s',  turn: 11, totalTurns: 18 },
  ...
  { time: '2026-05-12 09:31:51', relative: '18m ago', type: 'injection',  key: 'prod-agent (sk-gw-930)', action: 'flagged',  requestId: 'req_skylark_4218',  conversationId: 'cnv_skylark_18',   keyTier: 'elevated', status: 'success', code: '200', inTokens: '728',   outTokens: '348',   latency: '13.40s', turn: 4,  totalTurns: 6  },
