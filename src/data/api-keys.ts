...
export const API_KEY_SEED_ROWS: ApiKeyRow[] = [
  ...
  },
  {
    ...
    createdAt: new Date(2026, 4, 2, 11, 5, 44), // 2026-05-02 11:05:44
    lastUsed: new Date(2026, 4, 18, 8, 57, 21), // 2026-05-18 08:57:21
  },
  {
    id: "sk-gw-3b84f6e2",
    name: "nova-chat",
    ...
    createdAt: new Date(2026, 3, 22, 14, 31, 9), // 2026-04-22 14:31:09
    lastUsed: new Date(2026, 4, 18, 9, 48, 2), // 2026-05-18 09:48:02
  },
  {
    id: "sk-gw-a95d02c7",
    name: "hermes-agent",
    ...
    createdAt: new Date(2026, 4, 11, 9, 20, 37), // 2026-05-11 09:20:37
    lastUsed: new Date(2026, 4, 17, 22, 4, 55), // 2026-05-17 22:04:55
  },
  {
    id: "sk-gw-58e19d4f",
    name: "atlas-eval",
    ...
    createdAt: new Date(2026, 4, 14, 15, 46, 18), // 2026-05-14 15:46:18
    lastUsed: new Date(2026, 4, 18, 7, 33, 40), // 2026-05-18 07:33:40
  },
  {
    id: "sk-gw-e60c37ba",
    name: "development",
    ...
    createdAt: new Date(2026, 3, 30, 10, 2, 12), // 2026-04-30 10:02:12
    lastUsed: new Date(2026, 4, 18, 11, 26, 5), // 2026-05-18 11:26:05
  },
  {
    id: "sk-gw-14f7ab90",
    name: "ci-runner",
    ...
    createdAt: new Date(2026, 4, 5, 8, 15, 29), // 2026-05-05 08:15:29
    lastUsed: new Date(2026, 4, 18, 6, 12, 48), // 2026-05-18 06:12:48
  },
];
