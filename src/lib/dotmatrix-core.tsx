...
// Vendored from the `@dotmatrix` shadcn registry. The registry ships `ReactNode`,
// `useEffect`, and `useRef` imports it never uses; dropped so `tsc -b` stays
// clean, since any TS error blocks the Vercel build.
