          ...
          return (
            <button
              ...
              className={cn(
                ...
                "inline-flex items-center justify-center gap-2 px-3 font-medium font-sans text-xs transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40 motion-reduce:transition-none",
                size === "sm" ? "h-7" : "h-8",
                selected
        ...
        return (
          <button
            ...
            className={cn(
              ...
              "relative z-10 inline-flex items-center justify-center gap-2 rounded-xs font-medium font-sans text-xs transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40 motion-reduce:transition-none",
