                    ...
                    className={
                      isActive
                        ...
                        : isDisabled
                          ...
                          : "flex size-9 items-center justify-center rounded-sm text-muted-foreground transition-[color,background-color,transform] duration-150 ease-out hover:bg-neutral-100 hover:text-muted-foreground focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100"
                    }
                    disabled={isDisabled}
                    key={item.id}
                    onClick={
                  ...
                  className={
                    isActive
                      ...
                      : isDisabled
                        ...
                        : "flex items-center gap-3 rounded-sm border border-transparent px-2 py-2 text-muted-foreground transition-[color,background-color,transform] duration-150 ease-out hover:bg-neutral-50 hover:text-foreground focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100"
                  }
                  disabled={isDisabled}
                  key={item.id}
                  onClick={
