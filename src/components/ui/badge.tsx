  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-xs border border-transparent px-2 font-medium font-mono text-xs uppercase tabular-nums transition-[colors,box-shadow] duration-150 ease-out focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-3 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-danger-100 text-danger-800 focus-visible:ring-destructive/20 dark:bg-destructive/20 dark:text-danger-300 dark:focus-visible:ring-destructive/40 [a]:hover:bg-danger-200",
        outline:
        ...
        success:
          "bg-success-100 text-success-800 dark:bg-success-500/15 dark:text-success-300 [a]:hover:bg-success-200",
        warning:
          "bg-warning-100 text-warning-700 dark:bg-warning-500/15 dark:text-warning-300 [a]:hover:bg-warning-200",
        info: "bg-blue-700/10 text-blue-600 dark:bg-blue-500/15 dark:text-blue-300 [a]:hover:bg-blue-700/20",
