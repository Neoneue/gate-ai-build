  ...
  return (
    <TabsPrimitive.Tab
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:rounded-none group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:px-4 group-data-[variant=line]/tabs-list:pt-2 group-data-[variant=line]/tabs-list:pb-3 group-data-[variant=line]/tabs-list:text-neutral-600 group-data-[variant=line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:data-active:font-medium group-data-[variant=line]/tabs-list:data-active:text-neutral-900 group-data-[variant=line]/tabs-list:hover:bg-neutral-100 group-data-[variant=line]/tabs-list:hover:text-neutral-900 group-data-[variant=line]/tabs-list:data-active:hover:bg-transparent",
