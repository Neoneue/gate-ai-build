    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <m.path animate={starControls} d="M20 3v4" variants={STAR_VARIANTS} />
          <m.path
            animate={starControls}
            d="M22 5h-4"
            variants={STAR_VARIANTS}
          />
          <m.path animate={starControls} d="M4 17v2" variants={STAR_VARIANTS} />
          <m.path animate={starControls} d="M5 18H3" variants={STAR_VARIANTS} />
        </svg>
      </div>
    );
  }
